      ...
      <div className="relative -mt-16 mx-auto max-w-4xl px-4">
        <div className="rounded-2xl border border-border/60 bg-card/90 p-5 backdrop-blur">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-wrap items-center gap-3 text-sm text-muted-foreground">
                ...
                <span className="flex items-center gap-0.5">
                  ...
                  {(restaurant.delivery_fee ?? 0).toFixed(0)} delivery
                </span>
              </div>
            </div>
          </div>
          ...
          <p className="mt-2 flex items-center gap-0.5 text-xs text-muted-foreground">
            Minimum order: <IndianRupee className="size-3" />{(restaurant.min_order ?? 0).toFixed(0)}
          </p>
        </div>
      </div>
    ...
    <article className="flex gap-4 rounded-xl border border-border/60 bg-card/60 p-3 backdrop-blur transition-all hover:border-primary/30">
      ...
      <div className="flex flex-1 flex-col gap-1">
        ...
        <div className="mt-auto flex items-center justify-end pt-2">
          {quantityInCart > 0 ? (
            <div className="flex items-center gap-2 rounded-full border border-primary/40 bg-primary/10 px-1 py-1">
              <span className="pl-2 text-sm font-bold text-primary">{quantityInCart} in cart</span>
              <button
                onClick={onAddToCart}
